...
>
    import { buttonVariants, type ButtonProps } from "./index.ts";
    import { Button as ButtonPrimitive } from "bits-ui";
    import { cn } from "@lib/shared/utils/classes.ts";
    import { type ClassNameValue } from "tailwind-merge";
    import { type Component } from "svelte";
    import ContentRenderer from "@lib/shared/utils/content-renderer.svelte";
    import LoadingIndicator from "@ui/loading-indicator/index.ts";
